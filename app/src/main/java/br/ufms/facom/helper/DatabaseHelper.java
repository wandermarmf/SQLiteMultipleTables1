...
{
	private static String TAG = DatabaseHelper.class.getCanonicalName();
	// Logcat tag
	...
	private static final String CREATE_TABLE_TODO = "CREATE TABLE " + TABLE_TODO + "(" + KEY_ID + " INTEGER PRIMARY KEY," + KEY_TODO + " TEXT," + KEY_STATUS + " INTEGER," + KEY_CREATED_AT + " DATETIME" + ")";
	...
	private static final String CREATE_TABLE_TODO_TAG = "CREATE TABLE " + TABLE_TODO_TAG + "(" + KEY_ID + " INTEGER PRIMARY KEY," + KEY_TODO_ID + " INTEGER," + KEY_TAG_ID + " INTEGER," + KEY_CREATED_AT + " DATETIME" + ")";
	 ...
	 * get single todo
	 */
    private Todo doGetTodo(Cursor c) {
        Todo td = new Todo();
	...
	public ArrayList<Todo> getAllToDosByTag(String tag_name)
	{
		...
		String selectQuery = "SELECT  * FROM " + TABLE_TODO + " td, " + TABLE_TAG + " tg, " + TABLE_TODO_TAG + " tt WHERE tg." + KEY_TAG_NAME + " = '" + tag_name + "'" + " AND tg." + KEY_ID + " = " + "tt." + KEY_TAG_ID + " AND td." + KEY_ID + " = " + "tt." + KEY_TODO_ID;
	...
	public int updateToDo(Todo todo)
	{
		...
		// updating row
		return db.update(TABLE_TODO, values, KEY_ID + " = ?", new String[]
	...
	public int updateTag(Tag tag)
	{
		...
		// updating row
		return db.update(TABLE_TAG, values, KEY_ID + " = ?", new String[]
	...
	public void deleteTag(Tag tag, boolean should_delete_all_tag_todos)
	{
		...
		// now delete the tag
		db.delete(TABLE_TAG, KEY_ID + " = ?", new String[]
		{ String.valueOf(tag.getId()) });
	}
